...
private val onNextClick:() -> Unit) :
    ...
    private val data = arrayListOf<OnBoard>(
        OnBoard("https://d57439wlqx3vo.cloudfront.net/iblock/03c/03c3f81942edbe28e073436c1e47b227/64c181f8554dc9a0e27e654be545e45d.png",
                "Task Manager 1",
        ...
        OnBoard("https://toggl.com/blog/wp-content/uploads/2018/09/project-task-list.jpg",
                "Task Manager 2",
                "One of the most common examples of a task manager is the task manager utility in Microsoft Windows."),

        OnBoard("https://www.diffzy.com/articles/images/108/1.jpg",
                "Task Manager 3",
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): OnBoardingViewHolder {
        return  OnBoardingViewHolder(
            ItemOnboardingBinding.inflate(LayoutInflater.from(parent.context),
                parent,false)
        )
